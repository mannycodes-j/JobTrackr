...
export default function LoginPage() {
   return (
     <div className="flex min-h-screen flex-col">
       <header className="flex h-14 bg-white items-center shadow-lg border-b px-4 lg:px-6">
         ...
         >
           <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
             <div className="space-y-4">
               <h1 className="text-3xl font-bold text-black tracking-tighter md:pl-12 sm:text-4xl md:text-[35px]">
                 AI-Powered Job{' '}
                 <span className="text-[#2563eb]">Application Tracker</span>
               </h1>
               <p className="max-w-[600px] text-muted-foreground md:pl-12 md:text-[15px]">
                 Track your job applications, get AI-powered resume feedback,
                 and discover personalized job recommendations.
               </p>
         ...
         >
           ...
           <div className="relative container px-4 md:px-6">
             ...
             <div className="flex flex-col items-center justify-center gap-4 text-center">
               <div className="space-y-2">
                 <h2 className="text-3xl text-[#2563eb] font-bold tracking-tighter sm:text-4xl md:text-[35px]">
                   Key Features
                 </h2>
